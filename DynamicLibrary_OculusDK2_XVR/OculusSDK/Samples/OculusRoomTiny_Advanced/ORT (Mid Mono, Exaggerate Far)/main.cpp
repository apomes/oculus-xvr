...
int WINAPI WinMain(HINSTANCE hinst, HINSTANCE, LPSTR, int)
{
    ...
    auto midMonoEyeTexture = new Texture(true, basicVR.Layer[0]->pEyeRenderTexture[0]->SizeW, basicVR.Layer[0]->pEyeRenderTexture[0]->SizeH);
    auto renderMidMonoEyeTexture = new Model(new Material(midMonoEyeTexture), -1, -1, 1, 1);
    auto farMonoEyeTexture = new Texture(true, basicVR.Layer[0]->pEyeRenderTexture[0]->SizeW, basicVR.Layer[0]->pEyeRenderTexture[0]->SizeH);
    ...
    while (basicVR.HandleMessages())
    {
        ...
        basicVR.Layer[0]->RenderSceneToEyeBuffer(&basicVR.MainCam, &basicVR.RoomScene, 0, midMonoEyeTexture->TexRtv, &ots.HeadPose.ThePose, 1, 1, 1, 1, 1,
		...
		basicVR.MainCam.Pos = XMVectorAdd(basicVR.MainCam.Pos, XMVectorSet(0, 0, -60, 0));
		basicVR.Layer[0]->RenderSceneToEyeBuffer(&basicVR.MainCam, &basicVR.RoomScene, 0, farMonoEyeTexture->TexRtv, &ots.HeadPose.ThePose, 1, 1, 1, 1, 1,
				switchPoint + (visible ? 0.1f : -0.1f), 1000.0f);
		basicVR.MainCam.Pos = XMVectorAdd(basicVR.MainCam.Pos, XMVectorSet(0, 0, +60, 0));
